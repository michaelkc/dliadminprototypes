...
{
    public class NavisionprofilHistMap : EntityTypeConfiguration<NavisionprofilHist>
    {
        public NavisionprofilHistMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.Medlemsstatus, t.Ajourtid, t.Navisiontid, t.Ajourini, t.ReferenceNavisionident });
            ...
            this.Property(t => t.Medlemsstatus)
            ...
            this.Property(t => t.ReferenceNavisionident)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            // Table & Column Mappings
            this.ToTable("NavisionprofilHist");
