...
{
    public class SSOBrugerCprValidatedApplicationKeyMap : EntityTypeConfiguration<SSOBrugerCprValidatedApplicationKey>
    {
        public SSOBrugerCprValidatedApplicationKeyMap()
        {
            // Primary Key
            ...
            this.ToTable("SSOBrugerCprValidatedApplicationKeys");
